...
const contributionsColor = ['', '#ef4444', '#84cc16', '#06b6d4', '#f97316', '#22c55e', '#0ea5e9']
const percentageColor = ['#f97316', '#22c55e', '#0ea5e9', '#eab308', '#10b981', '#6366f1']
const studentsColor = ['#eab308', '#10b981', '#6366f1', '#ef4444', '#84cc16', '#06b6d4']
...
const Home = () => {
    ...
    const renderContributionBars = () => { 
        return Object.entries(Object.entries(contributions)).map(([i, [key]]) => {
            if (key !== 'name') return (
                <Bar key={i} dataKey={key} fill={contributionsColor[i]} />
            )
        })
    }
    ...
    return (
        <div style={{ padding: 12 }}>
            <h1>Statistics</h1>
            <div style={{ display: "flex", gap: 32, width: "100%", justifyContent: 'space-between'}}>
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    <PieChart width={400} height={400}>
                        <Pie data={percentage} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} label>
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    <PieChart width={400} height={400}>
                        <Pie data={students} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} label>
